---
name: ig-build
description: Compila e valida o IG FamilIAr_Ativa (sushi + IG Publisher), revisa o QA e registra lições. Use após /fhir-generate ou para validar o estado atual.
---
...
4. Registrar armadilhas em `docs/hard-earned-lessons.md` (a partir de HEL-101).
